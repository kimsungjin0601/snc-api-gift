...
public enum UserStatusType {
    ...
    private static final Map<String, String> codeMap =
            Collections.unmodifiableMap(Stream.of(values())
                    .collect(Collectors.toMap(UserStatusType::getCode, UserStatusType::name)));

    public static UserStatusType of(final String code){
        return UserStatusType.valueOf(codeMap.get(code));
    }
